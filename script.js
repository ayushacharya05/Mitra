...
function getFlexibleAnswer(question) {
    const predefinedAnswers = [
        /* Greetings */
        { "keywords": ["hello", "hi", "hey", "hii", "hy"], "answer": "Hi! How can I assist you today?\nनमस्ते! म तपाईंलाई आज के सहयोग गर्न सक्छु?" },
        { "keywords": ["नमस्ते", "नमस्कार", "Namaste"], "answer": "नमस्ते! म तपाईंलाई आज के सहयोग गर्न सक्छु?" },
        ...
        { "keywords": ["Ke cha halkhabar","Ke cha halkhabar?", "के छ खबर?", "के छ खबर?"], "answer": "मेरो त ठिकै छ, हजुरको?" },
        { "keywords": ["what's up?", "how are you?", "तपाईंलाई कस्तो छ?"], "answer": "I'm good!\nम ठिकै छु! तपाईंलाई कस्तो छ?" },
        { "keywords": ["i'm fine", "i am good","i'm good","i'm good too","All good", "म ठिक छु","म ठिकै छु", "म राम्रो छु"], "answer": "That's great to hear!\nत्यो सुनेर खुसी लाग्यो!" },
        { "keywords": ["who made you?", "तपाईंलाई कसले बनायो?", "developed by?", "who developed you?"], "answer": "I was created by Ayush Acharya\nमलाई आयुष आचार्यले बनाउनु भएको हो।" },
        { "keywords": ["your age?", "तपाईंको उमेर कति हो?","what's your age?"], "answer": "I'm an AI, so I don't have an age!\nम एआई हुँ, मेरो उमेर हुँदैन।" },
        ...
        { "keywords": ["Nothing much", "not much","खास केही छैन"], "answer": "Alright! कुरा गर्न मन लागे, म यहीं छु।\nठिक छ! केही भन्न मन लाग्यो भने भन्नु होला।" },
        ...
        { "keywords": ["what is AI?", "AI भनेको के हो?"], "answer": "AI means Artificial Intelligence — machines that can think like us.\nAI को मतलब हो कृत्रिम बुद्धिमत्ता — जो हामी जस्तै सोच्न सक्छ।" },
        ...
        {"keywords": ["can you solve math formula?", "math help", "solve equation"],
            "answer": "Some common math formulas include area of a circle (πr²) and the quadratic formula."
        },
        ...
        {"keywords": ["which gas do plants absorb?", "plant gas intake", "gas used in photosynthesis"],
            "answer": "Plants absorb carbon dioxide (CO₂) during photosynthesis."
        },
...
// Smart Voice Input with Nepali fallback
function startVoiceInput() {
    ...
    // Try to detect last AI message language
    const lastAIMessage = document.querySelector('.message.ai:last-child .bubble')?.innerText || '';
    const hasNepali = /[\u0900-\u097F]/.test(lastAIMessage);

    recognition.lang = hasNepali ? 'ne-NP' : 'en-US';
...
// Smart Text-to-Speech with Nepali/Hindi voice
function speakText(text) {
    ...
    const hasNepali = /[\u0900-\u097F]/.test(text); // Devanagari script
    const voices = window.speechSynthesis.getVoices();

    let selectedVoice = null;

    if (hasNepali) {
        // Priority: Nepali → Hindi → Indian English → Default
...
// Optional: Trigger voice load on first user interaction
